...
const HeroSection = () => {
  return (
    <section className="relative flex items-center px-6 pt-10 md:pt-14 pb-4 min-h-[auto] md:min-h-[60vh] overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full flex flex-col items-center text-center md:grid md:grid-cols-[1fr_auto] md:text-left md:items-center gap-8 md:gap-12">
        {/* Left */}
        <div className="flex flex-col items-center md:items-start">
          <motion.h1
            className="text-[28px] sm:text-4xl md:text-[2.8rem] font-bold leading-tight md:leading-[1.15] tracking-[-0.01em] text-white max-w-[500px] mb-3 md:mb-4"
          ...
          <motion.p
            className="text-[12px] md:text-[14px] text-gray-400 mb-5 md:mb-6"
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            className="flex flex-col w-[90%] sm:w-auto sm:flex-row items-center gap-3 mb-4"
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ ...spring, delay: 0.3 }}
          >
            <button className="glow-button w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-coral text-white px-6 py-2.5 rounded-xl text-[14px] md:text-[15px] font-semibold shadow-[0_0_25px_4px_rgba(255,90,54,0.4)]">
              <LayoutGrid className="w-4 h-4" />
              Descargar (3 días gratis)
            </button>
            <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 border border-white/15 text-white px-6 py-2.5 rounded-xl text-[14px] md:text-[15px] font-medium hover:bg-white/5 transition-all duration-300">
        ...
        <motion.div
          ...
          className="relative w-full max-w-[340px] md:w-[280px] md:max-w-none shrink-0 self-center"
        >
